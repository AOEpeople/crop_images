 ...
 */
class ImageSourceProcessorTest extends AbstractProcessorTest {

	/**
	 * @var \Aijko\CropImages\UserFunc\ImageSourceProcessor
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = new \Aijko\CropImages\UserFunc\ImageSourceProcessor();
	}
	 ...
	 * @test
	 */
	public function verifyChangingImageSourceWorks() {
		// Stub
		$stubFixture = $this->getAccessibleMock('Aijko\\CropImages\\UserFunc\\ImageSourceProcessor', array('getResponsiveFileReferenceUid'));
		$stubFixture
			->expects($this->any())
			->method('getResponsiveFileReferenceUid')
